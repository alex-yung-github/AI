...
def getFlatness(beegcols): #gets sample standard deviation, not population
    std = stdev(beegcols)
    return std
...
userInput()
# playGame([-0.7137342358257162, -0.31940822245024836, -0.4802756783606821, -0.045475780930285925, -0.9170388456710068])